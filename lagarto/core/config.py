...
CHAIN_BEZIER_SAMPLES = 8       # segments per chain Bezier render (quadratica)
CHAIN_SPARK_GAP = 0.07         # seconds between mid-link spark bursts
CHAIN_LINEWIDTH = 2            # px: espessura do chain
CHAIN_GLOW_RADIUS = 5          # px: raio do glow central
CHAIN_GLOW_ALPHA = 0.6         # 0..1: alpha do glow central
CHAIN_FLICKER_LERP = 0.3       # 0..1: suavizacao do control point entre frames
CHAIN_FLICKER_JITTER = 14      # px: raio do offset aleatorio do control point
CHAIN_ALPHA_MIN = 0.7          # alpha minimo do chain (fase de flicker)
CHAIN_ALPHA_MAX = 0.9          # alpha maximo do chain (fase de flicker)
