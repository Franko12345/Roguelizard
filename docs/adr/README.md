...
| [0012](./0012-two-dodge-verbs.md) | Two dodge verbs (Investida + Rolamento), both invulnerable | Two invulnerability buttons looks redundant; the asymmetry is what lets bullet density rise, and the pad's last free input is spent on it |
